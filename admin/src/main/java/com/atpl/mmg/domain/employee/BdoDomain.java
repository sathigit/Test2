...
public class BdoDomain {
	...
	public BdoDomain(String franchiseId, String firstName, String emailId, BigInteger mobileNumber,
			String franchiseName, String profileId) {
	...
	public BdoDomain(String firstName, String emailId, BigInteger mobileNumber, int beId) {
		this.firstName = firstName;
		this.emailId = emailId;
		this.mobileNumber = mobileNumber;
		this.beId = beId;
