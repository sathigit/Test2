...
import com.atpl.mmg.exception.MmgRestException.ACCESS_DENIED;
import com.atpl.mmg.exception.MmgRestException.BACKEND_PARSE_ERROR;
...
public class GenericHttpClient {
	...
	private static Map<String, Object> getResponse(final String reqBody, final String url, Map<String, String> headers,
		...
		if(!url.contains("/oauth/loadAuthentication")) {
