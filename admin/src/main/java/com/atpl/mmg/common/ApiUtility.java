...
import com.atpl.mmg.exception.MmgRestException.BACKEND_SERVER_READ_TIMEOUT;
...
public class ApiUtility {
	...
	public static CloseableHttpResponse doHttpDelete(final String url, Map<String, String> headers)
			throws Exception {
