...
public enum StatusCode {
	    ...
	    UNSUCCESS (513, "Not Valid"),
	    NO_SERVICE(601,  "Service Not Available"),
	    NO_SEVERITY(601,  "Severity Not Available"),
	    NO_CUSTOMERISSUES(601,  "Customerisuues Not Available"),
	    NO_DRIVERISSUES(601,  "Driverissues Not Available"),
	    NO_FRANCHISEISSUES(601,  "Franchiseissues Not Available"),
	    NO_FLEETISSUES(601,  "Fleetissues Not Available"),
	    NO_EMPLOYEES(601,  "Employees Not Available"),
	    AADHARNUMBER_EXISTS(601,  "Aadhar Number already Exists"),
	    ACCOUNTNUMBER_EXISTS(601,  "Account Number already Exists"),
	    PANNUMBER_EXISTS(601,  "Pan Number already Exists"),
	    AADHARNUMBER(601,  "Please fill the AadharNumber"),
	    PANNUMBER(601,  "Please fill the PanNumber"),
	    ACCOUNTNUMBER(601,  "Please fill the AccountNumber"),
	    NO_BDO(601,  "BDO's are not Available"),
	    NO_DETAILS(601,"Details not found!!"),
	    NO_QUOTATION(601,"Quotation not found!!")
	    ;
