...
public enum Role {
	...
	TIEUPS("7"), FAREESTIMATION("8"), FRANCHISE("9"), FLEETDRIVER("11"),COORDINATOR("12"),FIELDOFFICER("13"),HELPCENTERLEVEL2("14"),HELPCENTER("15"),HELPCENTERLEVEL3("16"),OPERATIONAL_TEAM("18"), ENTERPRISE("19"), BDM("20"), BDO("21"),CHANNEL_PARTNER("22"),ATPL("23");
